    ...
    >
      ...
      <motion.div
        ...
        className="w-4/5 max-xs:w-full max-lg:w-11/12 grid justify-items-center gap-y-5 gap-x-7 
          ...
          mb-10 max-md:mb-5"
      >
        <CardInfo name="Vasumitra" role="Community Leader" imgSrc="https://api.dicebear.com/9.x/avataaars/svg?seed=Liam&flip=true&accessories=round&accessoriesColor=3c4f5c,25557c,262e33,b1e2ff,5199e4,65c9ff&accessoriesProbability=100&clothing=blazerAndShirt&clothingGraphic[]&eyebrows=raisedExcited&eyes=closed&facialHair[]&facialHairColor[]&hairColor=2c1b18&mouth=twinkle&skinColor=edb98a&top=shortRound"/>
        <CardInfo name="Jake" role="Chief Administrator" imgSrc="https://api.dicebear.com/9.x/avataaars/svg?seed=Nolan&eyebrows=default,defaultNatural,flatNatural,raisedExcited,raisedExcitedNatural&eyes=closed,default,happy,side,squint,surprised,wink,winkWacky&mouth=default,eating,smile,tongue,twinkle&skinColor=d08b5b,edb98a,f8d25c,fd9841,ffdbb4,ae5d29"/>
        <CardInfo name="Abu Bakar" role="Administrator" imgSrc="https://api.dicebear.com/9.x/avataaars/svg?seed=Sara&eyebrows=default,defaultNatural,flatNatural,raisedExcited,raisedExcitedNatural&eyes=closed,default,happy,side,squint,surprised,wink,winkWacky&mouth=default,eating,smile,tongue,twinkle&skinColor=d08b5b,edb98a,f8d25c,fd9841,ffdbb4,ae5d29"/>
        <CardInfo className="max-md:flex hidden" name="Haz" role="Administrator" imgSrc="https://api.dicebear.com/9.x/avataaars/svg?seed=Mackenzie&eyebrows=default,defaultNatural,flatNatural,raisedExcited,raisedExcitedNatural&eyes=closed,default,happy,side,squint,surprised,wink,winkWacky&mouth=default,eating,smile,tongue,twinkle&skinColor=d08b5b,edb98a,f8d25c,fd9841,ffdbb4,ae5d29"/>
      </motion.div>
      ...
      >
        <CardInfo className="max-md:hidden flex" name="Haz" role="Administrator" imgSrc="https://api.dicebear.com/9.x/avataaars/svg?seed=Mackenzie&eyebrows=default,defaultNatural,flatNatural,raisedExcited,raisedExcitedNatural&eyes=closed,default,happy,side,squint,surprised,wink,winkWacky&mouth=default,eating,smile,tongue,twinkle&skinColor=d08b5b,edb98a,f8d25c,fd9841,ffdbb4,ae5d29"/>
        <CardInfo name="Alen" role="Administrator" imgSrc="https://api.dicebear.com/9.x/avataaars/svg?seed=Sara&eyebrows=default,defaultNatural,flatNatural,raisedExcited,raisedExcitedNatural&eyes=closed,default,happy,side,squint,surprised,wink,winkWacky&mouth=default,eating,smile,tongue,twinkle&skinColor=d08b5b,edb98a,f8d25c,fd9841,ffdbb4,ae5d29&top=dreads01,dreads02,frida,frizzle,fro,froBand,hat,hijab,longButNotTooLong,miaWallace,shaggy,shaggyMullet,shavedSides,shortCurly,shortFlat,shortRound,shortWaved,sides,straight01,straight02,straightAndStrand,theCaesar,theCaesarAndSidePart,turban,winterHat02,winterHat03,winterHat04,winterHat1"/>
      </motion.div>
